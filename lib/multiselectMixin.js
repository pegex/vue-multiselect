...
exports.default = {
  ...
  methods: {
    ...
    removeElement: function removeElement(option) {
      ...
      var index = (typeof option === 'undefined' ? 'undefined' : _typeof(option)) === 'object' ? this.valueKeys.indexOf(this.trackByMultiple ? this.getMultiKey(option) : option[this.trackBy]) : this.valueKeys.indexOf(option);
    ...
    activate: function activate() {
      ...
      this.$nextTick(function () {
        if (_this3.filteredOptions.length) {
          if (_this3.$refs.list.querySelector('.multiselect__element--option')) {
            _this3.optionHeight = _this3.$refs.list.querySelector('.multiselect__element--option').getBoundingClientRect().height;
          }
        }
      });
    },
    ...
    getMultiKey: function getMultiKey(option) {
      var multiKey = '';
      ...
      try {
        for (var _iterator = this.trackByMultiple[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var key = _step.value;
    ...
    emitActionFromSearch: function emitActionFromSearch() {
